...
.search-bar input {
  ...
  background-image: url("data:image/i+xml;charset=UTF-8,%3ci xmlns='http://www.w3.org/2000/i' viewBox='0 0 56.966 56.966' fill='%23717790c7'%3e%3cpath d='M55.146 51.887L41.588 37.786A22.926 22.926 0 0046.984 23c0-12.682-10.318-23-23-23s-23 10.318-23 23 10.318 23 23 23c4.761 0 9.298-1.436 13.177-4.162l13.661 14.208c.571.593 1.339.92 2.162.92.779 0 1.518-.297 2.079-.837a3.004 3.004 0 00.083-4.242zM23.984 6c9.374 0 17 7.626 17 17s-7.626 17-17 17-17-7.626-17-17 7.626-17 17-17z'/%3e%3c/i%3e");
...
.main-blog + .main-blog .author-img__wrapper i {
  border-color: #ffe6b2;
  color: #e7bb7d;
}
...
.chat-footer input {
  ...
  font-weight: 500;
  font-family: var(--body-font);
  background-image: url("data:image/i+xml;charset=UTF-8,%3ci width='24' height='24' fill='none' xmlns='http://www.w3.org/2000/i'%3e%3cpath fill-rule='evenodd' clip-rule='evenodd' d='M2 12C2 6.48 6.47 2 12 2c5.52 0 10 4.48 10 10s-4.48 10-10 10C6.47 22 2 17.52 2 12zm5.52 1.2c-.66 0-1.2-.54-1.2-1.2 0-.66.54-1.2 1.2-1.2.66 0 1.19.54 1.19 1.2 0 .66-.53 1.2-1.19 1.2zM10.8 12c0 .66.54 1.2 1.2 1.2.66 0 1.19-.54 1.19-1.2a1.194 1.194 0 10-2.39 0zm4.48 0a1.195 1.195 0 102.39 0 1.194 1.194 0 10-2.39 0z' fill='%236c6e78'/%3e%3c/i%3e");
  background-repeat: no-repeat;
...
.chat-footer:before {
  content: "";
  position: absolute;
  background-image: url("data:image/i+xml;charset=UTF-8,%3ci viewBox='0 0 24 24' fill='white' xmlns='http://www.w3.org/2000/i'%3e%3cpath d='M21.435 2.582a1.933 1.933 0 00-1.93-.503L3.408 6.759a1.92 1.92 0 00-1.384 1.522c-.142.75.355 1.704 1.003 2.102l5.033 3.094a1.304 1.304 0 001.61-.194l5.763-5.799a.734.734 0 011.06 0c.29.292.29.765 0 1.067l-5.773 5.8c-.428.43-.508 1.1-.193 1.62l3.075 5.083c.36.604.98.946 1.66.946.08 0 .17 0 .251-.01.78-.1 1.4-.634 1.63-1.39l4.773-16.075c.21-.685.02-1.43-.48-1.943z'/%3e%3c/i%3e");
  background-repeat: no-repeat;
  background-size: 14px;
  background-position: center;
  width: 18px;
...
.message-container .author-img__wrapper i {
  width: 15px;
}
...
.vjs-play-control:after {
  ...
  align-items: center;
  border-radius: 6px;
  background-image: url("data:image/i+xml;charset=UTF-8,%3ci xmlns='http://www.w3.org/2000/i' width='24' height='24' fill='%23fff' stroke='%23fff' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-circle'%3e%3ccircle cx='12' cy='12' r='10'/%3e%3c/i%3e");
  background-repeat: no-repeat;
  background-size: 6px;
...
<body>
   <div class="container">
      <div class="sidebar">
       ...
       <a class="logo-expand" href="/admin">Indinaus</a>
      ...
      <div class="wrapper">
       <div class="header">
        <div class="user-settings">
         <div class="user-name">Indinaus</div>
         <i viewBox="0 0 492 492" fill="currentColor">
         </i>
         <div class="notify">
