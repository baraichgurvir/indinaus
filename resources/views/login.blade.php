...
<div class="custom-container">
   <div class="forms-custom-container">
     <div class="signin-signup">
       <form action="#" class="sign-in-form">
         ...
         <p class="social-text" style="color: #378EEF; cursor: pointer">Forgot Password? Reset Now</p>
       </form>
   ...
   <div class="panels-custom-container">
...
@section('js')
    <script>
      ...
      custom_container.classList.add("sign-up-mode");
      });

      sign_in_btn.addEventListener("click", () => {
      custom_container.classList.remove("sign-up-mode");
      });
    </script>
@endsection